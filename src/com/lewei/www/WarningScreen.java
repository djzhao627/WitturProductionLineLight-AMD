				...
				case 5:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red1) {
								dealWittturBtnWarningToLewei("AMD;1");
							}
							red1 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red2) {
								dealWittturBtnWarningToLewei("AMD;2");
							}
							red2 = false;
						}
						break;
				...
				case 6:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red3) {
								dealWittturBtnWarningToLewei("AMD;3");
							}
							red3 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red4) {
								dealWittturBtnWarningToLewei("AMD;4");
							}
							red4 = false;
						}
						break;
				...
				case 7:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red5) {
								dealWittturBtnWarningToLewei("AMD;5");
							}
							red5 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red6) {
								dealWittturBtnWarningToLewei("AMD;6");
							}
							red6 = false;
						}
						break;
				...
				case 8:
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (red7) {
								dealWittturBtnWarningToLewei("AMD;7");
							}
							red7 = false;
						}
						break;
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (red8) {
								dealWittturBtnWarningToLewei("AMD;8");
							}
							isLost = true;
						} else {
							if (!yellow8 && !green8) {
