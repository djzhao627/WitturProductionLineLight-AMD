...
public class WarningScreen extends JFrame {
	...
	public WarningScreen() {
		...
		line = new JLabel("\u7EBF\u522B:AMD hanger Line");
		...
		SwingWorker background = new SwingWorker<String, int[]>() {
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (!red1) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;1");
									addInfoToLewei.add("AMD;1");
								}
							}
							isLost = true;
						} else {
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (!red2) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;2");
									addInfoToLewei.add("AMD;2");
								}
							}
							isLost = true;
						} else {
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (!red3) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;3");
									addInfoToLewei.add("AMD;3");
								}
							}
							isLost = true;
						} else {
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (!red4) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;4");
									addInfoToLewei.add("AMD;4");
								}
							}
							isLost = true;
						} else {
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (!red5) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;5");
									addInfoToLewei.add("AMD;5");
								}
							}
							isLost = true;
						} else {
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (!red6) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;6");
									addInfoToLewei.add("AMD;6");
								}
							}
							isLost = true;
						} else {
					...
					case 1:
						if (btn[2] == 1) {
							...
							if (!red7) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;7");
									addInfoToLewei.add("AMD;7");
								}
							}
							isLost = true;
						} else {
					...
					case 4:
						if (btn[2] == 1) {
							...
							if (!red8) {
								...
								// 警告记录存入数据库
								if (rangerNum >= 0) {
									addWarningInfo("AMD;8");
									addInfoToLewei.add("AMD;8");
								}
							}
							isLost = true;
						} else {
			...
			private void addWarningInfo(String string) {
				...
				try {
					...
					// 预警消息存入数据库
					wld.addWarningInfo(remark, 2);// 数字表示当前线别ID
				} catch (SQLException e) {
